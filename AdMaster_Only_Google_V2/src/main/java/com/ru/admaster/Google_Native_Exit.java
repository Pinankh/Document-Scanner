...
public class Google_Native_Exit extends Activity {


    public static LinearLayout adView1;
    private static LinearLayout adapp;

    public static void Google_Native_Exit(final Activity ctx, final FrameLayout nativeAdContainer,final LinearLayout App_ad) {

        AdLoader.Builder builder = new AdLoader.Builder(ctx, Utils.Google_Native);
        builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
            @Override
            public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                UnifiedNativeAdView adView = (UnifiedNativeAdView) ctx.getLayoutInflater().inflate(R.layout.google_native_exit, null);
...
// adView.setAdvertiserView(adView.findViewById(R.id.ad_advertiser));
    ...
    public static void App_Native_Exit(final Activity ctx, final LinearLayout app_big_ads) {

        if (Utils.Big_native != null) {
            if (Utils.Big_native.size() != 0) {
                LayoutInflater inflater = LayoutInflater.from(ctx);
                adapp = (LinearLayout) inflater.inflate(R.layout.app_big_ad_exit, app_big_ads, false);
